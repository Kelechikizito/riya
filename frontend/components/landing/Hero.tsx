      ...
      <div className="mx-auto max-w-6xl px-5 pb-20 pt-16 sm:px-8 sm:pb-28 sm:pt-24">
        <div className="max-w-3xl">
          ...
          <p className="mt-7 max-w-xl text-[17px] leading-relaxed text-muted sm:text-[19px]">
            Put USDC to work on Ethereum. Borrow against it on Creditcoin. The
            yield your deposit earns is proven across and quietly retires the
            debt, until you owe nothing.
          </p>
