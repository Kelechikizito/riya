...
contract HelperConfig is Script {
    ...
    /// @param spoke The Aave V4 Spoke to supply through — real on mainnet, mocked elsewhere.
    /// @param reserveId The reserve's index within `spoke`. Per-Spoke, not global.
    /// @param minHarvest Smallest harvest worth Ethereum gas. Doubles as the keeper's trigger.
